...
> **Skill specifica per EYS.** Include gli interattori di default estratti dal PDF di riferimento del progetto (studio RP25).
> Se il gene è EYS e non vengono forniti interattori, usa il set predefinito dalla letteratura.
> Per analisi comparativa generica su qualsiasi gene usa `/ppi-compare GENE INTERACTORS`.

Confronta gli interattori di EYS tra letteratura e database, identificando gap di conoscenza e candidati per validazione sperimentale.

## Come usare
`/eys-ppi-compare GENE_SYMBOL [INTERACTOR1,INTERACTOR2,...]`

Esempio: `/eys-ppi-compare EYS GRK7,AIPL1,DAG1,POMGNT1,POMT2,PROM1,KIF19,PDE6D`
Esempio (default EYS): `/eys-ppi-compare EYS`

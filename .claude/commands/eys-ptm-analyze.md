...
> **Skill ottimizzata per geni retinici legati a Retinitis Pigmentosa.**
> L'analisi biologica (step 4) include interpretazioni specifiche per fotorecettori, ciglio retinico e proteine associate a RP (EYS, AIPL1, RHO, ABCA4, GRK7…).
> Per analisi PTM generica su qualsiasi gene usa `/ptm-analyze GENE`.

Recupera e analizza tutte le modificazioni post-traduzionali (PTM) di una proteina retinica da UniProt, con posizioni esatte, tipo di modifica e contesto biologico nel dominio RP/fotorecettori.

## Come usare
`/eys-ptm-analyze GENE_SYMBOL`

Esempi:
- `/eys-ptm-analyze EYS`
- `/eys-ptm-analyze AIPL1`
- `/eys-ptm-analyze RHO`

...
> **Skill calibrata su geni di Retinitis Pigmentosa (RP25/EYS, RHO, RPGR…).**
> Gli esempi di classificazione del rischio (step 4) usano posizioni reali di EYS.
> La sezione Note prioritizza varianti RP25.
> Per analisi di impatto varianti generica su qualsiasi gene usa `/ptm-variant-impact GENE`.

Incrocia le varianti patologiche di un gene retinico con i siti PTM, identificando quali mutazioni possono distruggere siti di glicosilazione, fosforilazione o ponti disolfuro.

## Come usare
`/eys-ptm-variant-impact GENE_SYMBOL`

Esempi:
- `/eys-ptm-variant-impact EYS`
- `/eys-ptm-variant-impact RHO`
- `/eys-ptm-variant-impact RPGR`
